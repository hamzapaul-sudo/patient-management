...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id, final StackProps props) {
        ...
        FargateService authService = createFargateService(
                        ...
                        List.of(4005),
                        authServiceDb,
                        Map.of("JWT_SECRET", "1338164db7254f7c21a412b7fd22bbdc9a4f7405f097baf030aedb6ad2bd510d")
                    );
    ...
    private FargateService createFargateService(String id, String image_name, List<Integer> ports, DatabaseInstance db,
                                                Map<String, String> additionalEnvVars) {

        FargateTaskDefinition taskDefinition = FargateTaskDefinition.Builder
                .create(this, "Task" + image_name)
                .cpu(256)
                .memoryLimitMiB(512)
                .build();
        ...
        taskDefinition.addContainer(image_name + "Container", containerOptions.build());
